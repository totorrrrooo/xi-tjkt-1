	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="M.Rasyid Ridha" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Akmal" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Imam" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekertaris" Nama="Laura" Width="120px" />
						<div className="py-[3%]"></div>
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Kayla" Width="120px" />
						<div className="py-[3%]"></div>
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Humas" Nama="Ahmadi" Width="120px" />
						<div className="py-[3%]"></div>
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Humas" Nama="Raya" Width="120px" />
						<div className="py-[3%]"></div>
					</div>

					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="Kebersihan" Nama="Soon" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Soon" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Keagamaan" Nama="Soon" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					data-aos-duration="1100">
					<div className="flex-col">
						<BorderStruktur Jabatan="Perlengkapan" Nama="Soon" Width="120px" />
					</div>
